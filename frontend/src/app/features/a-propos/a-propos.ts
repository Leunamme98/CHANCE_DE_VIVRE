...
export class APropos {
  ...
  readonly localites = [
    'QUI_SOMMES_NOUS.ZONE_LOCALITE_ASSOME',
    'QUI_SOMMES_NOUS.ZONE_LOCALITE_TSEVIE',
    'QUI_SOMMES_NOUS.ZONE_LOCALITE_KPALIME',
    'QUI_SOMMES_NOUS.ZONE_LOCALITE_AVETONOU',
    'QUI_SOMMES_NOUS.ZONE_LOCALITE_DANYI',
    'QUI_SOMMES_NOUS.ZONE_LOCALITE_BAFILO',
    'QUI_SOMMES_NOUS.ZONE_LOCALITE_NKASSAIDE',
    'QUI_SOMMES_NOUS.ZONE_LOCALITE_DAPAONG',
  ];
