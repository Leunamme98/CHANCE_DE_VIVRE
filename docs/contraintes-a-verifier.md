...
- [ ] **Liste des indicatifs téléphoniques** (`indicatifs-telephoniques.config.ts`) : 16 pays (Togo + Afrique de l'Ouest + quelques pays occidentaux courants), volontairement non exhaustive — à compléter si des partenaires/donateurs d'autres pays doivent être couverts
